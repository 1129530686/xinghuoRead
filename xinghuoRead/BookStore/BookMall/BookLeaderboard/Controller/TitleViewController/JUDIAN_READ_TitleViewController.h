//
//  JUDIAN_READ_BaseViewController.h
//
...
typedef enum : NSUInteger {
    kTitleColorGradientStyleRGB , // RGB:默认RGB样式
    kTitleColorGradientStyleFill, // 填充
} TitleColorGradientStyle;

@interface JUDIAN_READ_TitleViewController : JUDIAN_READ_BaseViewController
