...
@interface JUDIAN_READ_CycleVerticalView ()
{
...
@property (strong, nonatomic) JUDIAN_READ_CycleView *view1;
@property (strong, nonatomic) JUDIAN_READ_CycleView *view2;

@property (strong, nonatomic) JUDIAN_READ_CycleView *tmpTopView;
@property (strong, nonatomic) JUDIAN_READ_CycleView *tmpMiddleView;
@property (strong, nonatomic) JUDIAN_READ_CycleView *tmpBtmView;

@end

@implementation JUDIAN_READ_CycleVerticalView
...
- (void)initUI{
    self.view1 = [[JUDIAN_READ_CycleView alloc]init];
//    self.view1.backgroundColor = [UIColor clearColor];

    self.view2 = [[JUDIAN_READ_CycleView alloc]init];
