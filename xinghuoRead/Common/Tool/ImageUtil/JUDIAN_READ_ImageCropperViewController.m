//
//  JUDIAN_READ_ImageCropperViewController.m
//
//
...
@interface JUDIAN_READ_ImageCropperViewController ()
...
@implementation JUDIAN_READ_ImageCropperViewController
...
- (void)initControlBtn {
    ...
    NSInteger offset = topOffset + bottomOffset + 50;
    
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - offset, 100, 50)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100.0f, self.view.frame.size.height - offset, 100, 50)];
...
- (void)cancel:(id)sender {
    if (self.delegate && [self.delegate conformsToProtocol:@protocol(JUDIAN_READ_ImageCropperDelegate)]) {
