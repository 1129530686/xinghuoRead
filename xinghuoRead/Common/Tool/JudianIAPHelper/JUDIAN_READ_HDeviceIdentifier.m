...
@implementation JUDIAN_READ_HDeviceIdentifier
...
+(BOOL)syncDeviceIdentifier{
     ...
     */
    BOOL f = [JUDIAN_READ_KeychainUtils storeUsername:@"deviceIdentifier" andPassword:myUUIDStr forServiceName:bundleIdentifier updateExisting:NO error:nil];
...
+(NSString*)deviceIdentifier{
    ...
    //从钥匙串中获取唯一设备标识
    NSString * deviceIdentifier = [JUDIAN_READ_KeychainUtils getPasswordForUsername:@"deviceIdentifier" andServiceName:bundleIdentifier error:nil];
